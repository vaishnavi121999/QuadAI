...
def check_collision(state):
    ...
    """
    dist1 = np.sqrt((state[0] - OBSTACLE_CENTERS[0][0]) ** 2 + (state[2] - OBSTACLE_CENTERS[0][1]) ** 2)
    dist2 = np.sqrt((state[0] - OBSTACLE_CENTERS[1][0]) ** 2 + (state[2] - OBSTACLE_CENTERS[1][1]) ** 2)
    dist3 = np.sqrt((state[0] - OBSTACLE_CENTERS[2][0]) ** 2 + (state[2] - OBSTACLE_CENTERS[2][1]) ** 2)
